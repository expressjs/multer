...
function makeMiddleware (setup) {
  return function multerMiddleware (req, res, next) {
    ...
    switch (errorHandling) {
      ...
      case 'manual': break
      default: throw new Error('Unknown error handling: ' + errorHandling)
    }
    ...
    function automaticErrorHandler (uploadError) {
    ...
    function manualErrorHandler (uploadError) {
    ...
    function abortWithError (uploadError) {
      pendingWrites.onceZero(function () {
        switch (errorHandling) {
          case 'automatic': return automaticErrorHandler(uploadError)
          case 'manual': return manualErrorHandler(uploadError)
        }
      })
    }
