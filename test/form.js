    ...
    it('should process multipart/form-data POST request', function (done) {
        ...
        request(app)
            ...
            .end(function (err, res) {
                ...
                expect(form.files.small0[0].buffer).to.be.undefined;
                done();
            })
    ...
    it('should not process non-multipart POST request', function (done) {
        request(app)
            ...
            .end(function (err, res) {
                var form = res.body;
                expect(err).to.be.null;
                expect(form).to.not.have.property('body');
                expect(form).to.not.have.property('files');
                done();
            })
    ...
    it('should process multiple files', function (done) {
        ...
        request(app)
            ...
            .end(function (err, res) {
                ...
                expect(form.files.empty[0].buffer).to.be.undefined;
                ...
                expect(form.files.tiny0[0].buffer).to.be.undefined;
                ...
                expect(form.files.tiny1[0].buffer).to.be.undefined;
                ...
                expect(form.files.small1[0].buffer).to.be.undefined;
                ...
                expect(form.files.medium[0].buffer).to.be.undefined;
                ...
                expect(form.files.large[0].buffer).to.be.undefined;
